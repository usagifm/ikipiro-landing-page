...
export default function Home() {
  return (
    ...
    <div >
              ...
              <div class="nav-inner">
                ...
                <nav class="navbar navbar-expand-lg">
                  ...
                  <div class="button add-list-button">
                    <a target="_blank" href="https://apps.apple.com/id/app/ikipiro/id6444369537?l=id" class="btn">Download Sekarang </a>
                  </div>
                </nav>
          ...
          <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                  <div class="single-achievement wow fadeInUp" data-wow-delay=".8s">
                    <h3 class="counter"><span id="secondo2" class="countup" cup-end="120">2</span></h3>
                    <p>Happy Users</p>
                  </div>
                </div>
                <div class="col-lg-4 col-md-4 col-12">
                  <div class="single-achievement wow fadeInUp" data-wow-delay=".8s">
                    <h3 class="counter"><span id="secondo3" class="countup" cup-end="125">24</span>+</h3>
                    <p>Downloads</p>
                  </div>
                </div>
              </div>
      ...
      {/* <iframe width="560" height="315" src="https://www.youtube.com/embed/quUcPNZL2sw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
     */}
      {/* <section>
        <div class="container">
            <div class="row">
                    ...
                    <div class="single-footer f-link">
                      ...
                      <Center  >
                        ...
                        <div class="container-iframe">
                          ...
                          <iframe class="responsive-iframe" src="https://www.youtube.com/embed/3d9fIOdUEl4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
